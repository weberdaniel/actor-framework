...
class CAF_CORE_EXPORT scoped_coordinator : public ref_counted,
                                           public coordinator {
public:
  void run();
  ...
  void schedule(action_ptr action) override;
...
private:
  ...
  void dispatch_request(observable_base* source, observer_base* sink,
                        size_t n) override;

  void dispatch_cancel(observable_base* source, observer_base* sink) override;
